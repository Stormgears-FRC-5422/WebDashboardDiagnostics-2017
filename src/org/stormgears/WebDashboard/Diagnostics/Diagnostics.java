...
public class Diagnostics {
	...
	public static void init() {
		 ...
		 */
		TeeOutputStream out = new TeeOutputStream(System.out, new WriterOutputStream(new BufferedWriter(new WBLogWriter("STDOUT")), "UTF-8"));
		PrintStream outPs = new PrintStream(out);
		System.setOut(outPs);

		TeeOutputStream err = new TeeOutputStream(System.err, new WriterOutputStream(new BufferedWriter(new WBLogWriter("STDERR")), "UTF-8"));
